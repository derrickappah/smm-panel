/**
 * Admin API Endpoint to Verify and Approve Expired Deposits
 * 
 * Path: /api/admin/approve-expired-deposit
 * 
 * SECURITY: Requires admin authentication.
 * 
 * This endpoint allows admins to manually verify an expired deposit against the
 * Moolre payment gateway API and approve it.
 */
