  ...
  try {
    ...
    try {
      ...
      await logSecurityEvent({
        ...
        description: `Failed manual Moolre verification attempt: ${authError.message}`,
        metadata: {
    ...
    try {
      ...
      if (!moolreData) {
        console.error('[MANUAL-VERIFY-MOOLRE] Non-JSON response from Moolre:', moolreText);
    ...
    await logAdminAction({
      ...
      description: `Manual Moolre deposit verification: ${paymentStatus}`,
      metadata: {
