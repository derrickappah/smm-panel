-- Update place_order_with_balance_deduction function to include comments
-- Run this in Supabase SQL Editor

-- Drop the old function (with worldofsmm_order_id parameter)
DROP FUNCTION IF EXISTS place_order_with_balance_deduction(UUID, TEXT, INTEGER, NUMERIC, UUID, UUID, TEXT, TEXT, INTEGER, TEXT);

-- Recreate with comments parameter
...
GRANT EXECUTE ON FUNCTION place_order_with_balance_deduction(UUID, TEXT, INTEGER, NUMERIC, UUID, UUID, TEXT, TEXT, INTEGER, TEXT, TEXT) TO service_role, authenticated;
