-- Add require_otp setting to app_settings table and update RLS policy
-- This allows admins to turn OTP verification on/off via the admin settings

INSERT INTO app_settings (key, value, description)
VALUES ('require_otp', 'true', 'Require OTP verification for registration and sensitive activities')
ON CONFLICT (key) DO NOTHING;

-- Recreate the public select policy to include require_otp
