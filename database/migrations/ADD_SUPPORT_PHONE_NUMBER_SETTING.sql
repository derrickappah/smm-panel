-- Add support_phone_number setting to app_settings table
-- Insert default support phone number setting
INSERT INTO app_settings (key, value, description)
VALUES 
    ('support_phone_number', '0500865092', 'Phone number for support voice calls')
ON CONFLICT (key) DO NOTHING;

-- Recreate the public select policy to include support_phone_number
