-- Update place_order_with_balance_deduction function to include worldofsmm_order_id
-- Run this in Supabase SQL Editor

-- Drop the old function (with JB SMM Panel parameters)
DROP FUNCTION IF EXISTS place_order_with_balance_deduction(UUID, TEXT, INTEGER, NUMERIC, UUID, UUID, TEXT, TEXT, INTEGER);

-- Recreate with worldofsmm_order_id parameter
...
GRANT EXECUTE ON FUNCTION place_order_with_balance_deduction(UUID, TEXT, INTEGER, NUMERIC, UUID, UUID, TEXT, TEXT, INTEGER, TEXT) TO service_role, authenticated;
