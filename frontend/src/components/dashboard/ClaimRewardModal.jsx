...
import { Gift, Loader2, CheckCircle, XCircle, AlertCircle, Heart, Eye, ArrowRight, Clock, ShieldCheck, Zap, Lock, Unlock, Trophy } from 'lucide-react';
            ...
            <DialogContent className="sm:max-w-[550px] p-0 overflow-hidden border-none bg-[#fdfcff] shadow-xl rounded-[28px] max-h-[85vh] flex flex-col">
                {selectedTier ? (
                    ...
                    <div className="flex flex-col h-full animate-in fade-in zoom-in-95 duration-200">
                        <div className="p-6 border-b flex items-center justify-between bg-gray-50/50">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">Confirm your reward details</p>
                            </div>
                            <Button variant="ghost" size="sm" onClick={() => setSelectedTier(null)} className="h-8 w-8 p-0 rounded-full hover:bg-gray-100">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className={cn(
                                            "flex flex-col items-center p-4 rounded-xl border transition-all relative overflow-hidden",
                    ...
                    <>
                        ...
                        {!checkingEligibility && nextLockedTier && (
