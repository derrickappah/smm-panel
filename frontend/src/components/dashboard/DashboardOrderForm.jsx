...
const DashboardOrderForm = React.memo(({
  ...
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg p-6 sm:p-8 shadow-xl w-full min-w-0 max-w-full overflow-hidden" id="order-form-section">
      ...
      <form onSubmit={handleOrder} className="space-y-4">
        <div className="relative">
          ...
          <div className="relative service-dropdown-container">
            ...
            {selectOpen && filteredServices.length > 0 && (
              <div
        ...
        {isCustomCommentsService && (
          <div className="animate-fadeIn">
            ...
            <textarea
              ...
              rows={5}
              className="w-full rounded-lg border-2 border-blue-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-h-[120px] p-3 text-sm outline-none shadow-sm"
            />
          </div>
        )}
