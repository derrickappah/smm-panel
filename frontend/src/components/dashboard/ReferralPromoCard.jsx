...
const ReferralPromoCard = ({ onAction }) => {
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-sm border border-gray-100 flex flex-row items-center justify-between gap-3 sm:gap-8 overflow-hidden relative group animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex-1 space-y-3 sm:space-y-6 z-10">
        ...
        <button 
          onClick={onAction}
          className="flex items-center gap-1 sm:gap-2 text-purple-600 font-bold text-xs sm:text-xl hover:gap-3 transition-all duration-300 group/btn focus:outline-none"
        >
          Start Earning Now
