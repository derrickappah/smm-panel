                ...
                <CarouselContent className="-ml-2 md:-ml-4">
                    {packages.map((pkg) => (
                        <CarouselItem key={pkg.id} className="pl-2 md:pl-4 basis-[85%] sm:basis-[70%] md:basis-1/2 lg:basis-1/3">
                            <div
                                className="relative bg-white border-2 border-purple-200 rounded-2xl p-4 sm:p-5 transition-all duration-300 hover:border-purple-300 cursor-pointer h-full min-h-[190px] flex flex-col"
