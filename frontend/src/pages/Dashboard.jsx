...
const Dashboard = ({ user, onLogout, onUpdateUser }) => {
  ...
  const handleOrder = useCallback(async (e) => {
    ...
    try {
      ...
      // Clear form
      setOrderForm({ service_id: '', package_id: '', link: '', quantity: '', comments: '' });
      ...
      toast.error(error.message || 'An unexpected error occurred while placing your order.');
    } finally {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-6 pb-6 sm:pb-8">
        ...
        <div className="mb-6 sm:mb-8 animate-fadeIn">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Welcome back, {displayUser.name}! (v1.0.1-reward-fix)</h1>
