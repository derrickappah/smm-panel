...
import { ShieldCheck, Mail, RefreshCw, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-4 animate-fadeIn">
          ...
          <div className="flex items-center justify-center gap-3 mb-3 flex-wrap">
            <div className="flex items-center gap-1 text-gray-600" style={{ fontSize: '10px' }}>
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="w-full h-11 pr-10 rounded-lg border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
                <button
                  type="button"
