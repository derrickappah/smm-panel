      ...
      <div className="grid grid-cols-12 gap-4 p-4 items-start bg-white hover:bg-gray-50 transition-colors min-h-[100px]">
        ...
        <div className="col-span-1">
          <div className="flex flex-col gap-2 w-full">
            ...
            {!order.smmgen_order_id && !order.smmcost_order_id && !order.jbsmmpanel_order_id && !order.worldofsmm_order_id &&
              (order.services?.smmgen_service_id || order.services?.smmcost_service_id || order.services?.worldofsmm_service_id) &&
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            {(() => {
              ...
              } else if (order.smmtake_order_id === "order not placed at smmtake" || String(order.smmtake_order_id || '').toLowerCase() === "order not placed at smmtake") {
                return (
                  <div className="flex items-center gap-1 mt-1">
                    <AlertCircle className="w-4 h-4 text-red-500" />
              ...
              } else if (serviceHasSmmtake && !hasSmmtake) {
                return (
                  <div className="flex items-center gap-1 mt-1">
                    <AlertCircle className="w-4 h-4 text-red-500" />
                    <p className="text-xs text-red-600 italic font-medium">Order not placed at SMM Take</p>
