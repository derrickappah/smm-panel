...
const ServicesPage = ({ user, onLogout }) => {
  ...
  const fetchServices = async () => {
    ...
    try {
      ...
      let query = supabase.from('services').select('id, name, description, rate, platform, enabled, min_quantity, max_quantity, service_type, smmgen_service_id, smmcost_service_id, display_order, created_at').eq('enabled', true);
